...
export const config = {
    ...
    stripe: {
        ...
        proMonthlyUsdPriceId: getRequiredEnv("STRIPE_PRO_MONTHLY_USD_PRICE_ID"),
        proYearlyUsdPriceId: getRequiredEnv("STRIPE_PRO_YEARLY_USD_PRICE_ID"),
        teamSmallMonthlyUsdPriceId: getRequiredEnv("STRIPE_TEAM_SMALL_MONTHLY_USD_PRICE_ID"),
        teamSmallYearlyUsdPriceId: getRequiredEnv("STRIPE_TEAM_SMALL_YEARLY_USD_PRICE_ID"),
        teamStandardMonthlyUsdPriceId: getRequiredEnv("STRIPE_TEAM_STANDARD_MONTHLY_USD_PRICE_ID"),
        teamStandardYearlyUsdPriceId: getRequiredEnv("STRIPE_TEAM_STANDARD_YEARLY_USD_PRICE_ID"),
        teamEnterpriseMonthlyUsdPriceId: getRequiredEnv("STRIPE_TEAM_ENTERPRISE_MONTHLY_USD_PRICE_ID"),
        teamEnterpriseYearlyUsdPriceId: getRequiredEnv("STRIPE_TEAM_ENTERPRISE_YEARLY_USD_PRICE_ID"),
    ...
    subscription: {
        scopeEnforcementEnabled:
            getOptionalEnv("SUBSCRIPTION_SCOPE_ENFORCEMENT", "false") === "true",
    },
} as const;
